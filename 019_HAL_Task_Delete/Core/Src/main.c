...
int main(void)
{
  ...
  osThreadDef(Task1, Task1_Handler, osPriorityHigh, 0, 128);
...
void Task1_Handler(void const * argument)
{
  ...
  for(;;)
  {
	  ...
	  HAL_Delay(1000);
	     ...
	     //vTaskDelete cmsis_os  dosyası altında çalıştırılmaması iyi olur.
	     		}
  }
  /* USER CODE END 5 */
}
...
void Task2_Handler(void const * argument)
{
  ...
  for(;;)
  {
	  ...
	  HAL_Delay(1000);
	 // osDelay(500); mikrodenetleyiciyi durdurmuyor bu yüzden kullanmıyoruz.
  }
