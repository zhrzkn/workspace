...
int main(void)
{
  ...
  osThreadDef(ledTask, ledFlashTask, osPriorityNormal, 0, 128);
...
void readButtonStateTask(void const * argument)
{
  /* USER CODE BEGIN readButtonStateTask */
  /* Infinite loop */
  for(;;)
  {
    if(HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0)== GPIO_PIN_SET)
    {
    	...
    	osSignalSet(ledTaskHandle, 0x00);
    }
  }
  /* USER CODE END readButtonStateTask */
}
